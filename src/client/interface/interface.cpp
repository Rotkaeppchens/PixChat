...
InterfaceChatTab::InterfaceChatTab(int x, int y, int w, int h, const std::string &Target)
{
    ...
    this->FlGroup = new Fl_Group(x, y, w, h, this->ChatTarget.c_str());
    {
         ...
         * Text Output
         */
        Fl_Text_Display* Display = new Fl_Text_Display(x + 10, y + 10, w - 20, 280);
         ...
         * Text Input
         */
        Fl_Text_Editor* InputEditor = new Fl_Text_Editor(x + 10, y + 300, w - 130, 140);
         ...
         * Send Button
         */
        Fl_Button* SendButton = new Fl_Button(680, y + 300, 100, 140, "Send");
